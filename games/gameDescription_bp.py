...
from games.services import find_game_by_title,get_sorted_publisher_and_genres
...
def game_description():
    ...
    if game_title:
        ...
        if game:
            ...
            return render_template("gameDescription.html", game=game, genre_str=genre_str,all_genres=all_genres,all_publishers = all_publishers)
        else:
